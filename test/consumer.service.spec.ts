import { SqsConsumerService } from '../src/Application/services/consumer.service';
...
describe('SqsConsumerService', () => {
  ...
  beforeEach(() => {
    ...
    service = new SqsConsumerService(mockOrdersService, configService, mockAwsSqsService);
  });
